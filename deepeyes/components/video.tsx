...
export default function VideoPage() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row">
      ...
      <div
        className={cn("relative h-1/2 md:h-[90vh] transition-all", isCollapsed ? "w-[97.6vw]" : "w-full md:w-2/3 lg:w-3/4")}
      >
        <video
      ...
      <div
        className={cn(
          ...
          isCollapsed ? "hidden" : "h-1/2 md:h-[90vh] md:w-1/3 lg:w-1/4",
        )}
      >
